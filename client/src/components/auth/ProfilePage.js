				...
				<section className="user-profile">
					...
					<div>
						...
						<form onSubmit={this.onSubmit}>
							...
							/>
							<button type="submit" className="btn btn-primary" id="newMovieSubmitBtn">
								Submit
							</button>
							...
							/>
							<button className="btn btn-primary" id="searchMoveByNameBtn">
								Search
							</button>
							<button className="btn btn-primary" id="showAllMoviesBtn">
								Show All
							</button>
						</form>
					</div>
